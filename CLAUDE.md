...
- Setiap run: jalankan skill `job-search`, lalu tulis hasil ke folder `output/` DAN ke database Notion "Job Pipeline".
- Hindari duplikat: bandingkan dengan report di folder `output/` dari run sebelumnya.
